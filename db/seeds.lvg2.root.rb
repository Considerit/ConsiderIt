...
z99169 = Domain.create!(
  :identifier => 99169,
  :name => 'Ritzville'
)

z99341 = Domain.create!(
  :identifier => 99341,
  :name => 'Lind'
)

z99344 = Domain.create!(
  :identifier => 99344,
  :name => 'Othello'
)

z99371 = Domain.create!(
  :identifier => 99371,
  :name => 'Washtucna'
)

z99401 = Domain.create!(
  :identifier => 99401,
  :name => 'Anatone'
)

z99402 = Domain.create!(
  :identifier => 99402,
  :name => 'Asotin'
)

z99403 = Domain.create!(
  :identifier => 99403,
  :name => 'Clarkston'
)
...
z99337 = Domain.create!(
  :identifier => 99337,
  :name => 'Kennewick'
)

z99338 = Domain.create!(
  :identifier => 99338,
  :name => 'Kennewick'
)

z99345 = Domain.create!(
  :identifier => 99345,
  :name => 'Paterson'
)

z99346 = Domain.create!(
  :identifier => 99346,
  :name => 'Plymouth'
)

z99350 = Domain.create!(
  :identifier => 99350,
  :name => 'Prosser'
)

z99352 = Domain.create!(
  :identifier => 99352,
  :name => 'Richland'
)
...
z98801 = Domain.create!(
  :identifier => 98801,
  :name => 'Wenatchee'
)

z98807 = Domain.create!(
  :identifier => 98807,
  :name => 'Wenatchee'
)

z98811 = Domain.create!(
  :identifier => 98811,
  :name => 'Ardenvoir'
)

z98815 = Domain.create!(
  :identifier => 98815,
  :name => 'Cashmere'
)

z98816 = Domain.create!(
  :identifier => 98816,
  :name => 'Chelan'
)
...
z98822 = Domain.create!(
  :identifier => 98822,
  :name => 'Entiat'
)

z98826 = Domain.create!(
  :identifier => 98826,
  :name => 'Leavenworth'
)

z98828 = Domain.create!(
  :identifier => 98828,
  :name => 'Malaga'
)

z98831 = Domain.create!(
  :identifier => 98831,
  :name => 'Manson'
)

z98836 = Domain.create!(
  :identifier => 98836,
  :name => 'Monitor'
)

z98847 = Domain.create!(
  :identifier => 98847,
  :name => 'Peshastin'
)

z98852 = Domain.create!(
  :identifier => 98852,
  :name => 'Stehekin'
)

z98305 = Domain.create!(
  :identifier => 98305,
  :name => 'Beaver'
)

z98324 = Domain.create!(
  :identifier => 98324,
  :name => 'Carlsborg'
)
...
z98382 = Domain.create!(
  :identifier => 98382,
  :name => 'Sequim'
)

z98601 = Domain.create!(
  :identifier => 98601,
  :name => 'Amboy'
)
...
z98660 = Domain.create!(
  :identifier => 98660,
  :name => 'Vancouver'
)

z98661 = Domain.create!(
  :identifier => 98661,
  :name => 'Vancouver'
)

z98662 = Domain.create!(
  :identifier => 98662,
  :name => 'Vancouver'
)

z98663 = Domain.create!(
  :identifier => 98663,
  :name => 'Vancouver'
)

z98664 = Domain.create!(
  :identifier => 98664,
  :name => 'Vancouver'
)

z98665 = Domain.create!(
  :identifier => 98665,
  :name => 'Vancouver'
)

z98666 = Domain.create!(
  :identifier => 98666,
  :name => 'Vancouver'
)

z98667 = Domain.create!(
  :identifier => 98667,
  :name => 'Vancouver'
)

z98668 = Domain.create!(
  :identifier => 98668,
  :name => 'Vancouver'
)

z98671 = Domain.create!(
  :identifier => 98671,
  :name => 'Washougal'
)

z98675 = Domain.create!(
  :identifier => 98675,
  :name => 'Yacolt'
)

z98682 = Domain.create!(
  :identifier => 98682,
  :name => 'Vancouver'
)

z98683 = Domain.create!(
  :identifier => 98683,
  :name => 'Vancouver'
)

z98684 = Domain.create!(
  :identifier => 98684,
  :name => 'Vancouver'
)

z98685 = Domain.create!(
  :identifier => 98685,
  :name => 'Vancouver'
)

z98686 = Domain.create!(
  :identifier => 98686,
  :name => 'Vancouver'
)

z98687 = Domain.create!(
  :identifier => 98687,
  :name => 'Vancouver'
)

z99328 = Domain.create!(
  :identifier => 99328,
  :name => 'Dayton'
)

z99359 = Domain.create!(
  :identifier => 99359,
  :name => 'Starbuck'
)

z98581 = Domain.create!(
  :identifier => 98581,
  :name => 'Ryderwood'
)

z98603 = Domain.create!(
  :identifier => 98603,
  :name => 'Ariel'
)

z98609 = Domain.create!(
  :identifier => 98609,
  :name => 'Carrolls'
)
...
z98625 = Domain.create!(
  :identifier => 98625,
  :name => 'Kalama'
)

z98626 = Domain.create!(
  :identifier => 98626,
  :name => 'Kelso'
)

z98632 = Domain.create!(
  :identifier => 98632,
  :name => 'Longview'
)

z98645 = Domain.create!(
  :identifier => 98645,
  :name => 'Silverlake'
)

z98649 = Domain.create!(
  :identifier => 98649,
  :name => 'Toutle'
)

z98674 = Domain.create!(
  :identifier => 98674,
  :name => 'Woodland'
)
...
z98830 = Domain.create!(
  :identifier => 98830,
  :name => 'Mansfield'
)

z98843 = Domain.create!(
  :identifier => 98843,
  :name => 'Orondo'
)

z98845 = Domain.create!(
  :identifier => 98845,
  :name => 'Palisades'
)
...
z99107 = Domain.create!(
  :identifier => 99107,
  :name => 'Boyds'
)

z99118 = Domain.create!(
  :identifier => 99118,
  :name => 'Curlew'
)

z99121 = Domain.create!(
  :identifier => 99121,
  :name => 'Danville'
)

z99138 = Domain.create!(
  :identifier => 99138,
  :name => 'Inchelium'
)

z99140 = Domain.create!(
  :identifier => 99140,
  :name => 'Keller'
)

z99146 = Domain.create!(
  :identifier => 99146,
  :name => 'Laurier'
)

z99150 = Domain.create!(
  :identifier => 99150,
  :name => 'Malo'
)

z99160 = Domain.create!(
  :identifier => 99160,
  :name => 'Orient'
)

z99166 = Domain.create!(
  :identifier => 99166,
  :name => 'Republic'
)

z99301 = Domain.create!(
  :identifier => 99301,
  :name => 'Pasco'
)

z99302 = Domain.create!(
  :identifier => 99302,
  :name => 'Pasco'
)

z99326 = Domain.create!(
  :identifier => 99326,
  :name => 'Connell'
)

z99330 = Domain.create!(
  :identifier => 99330,
  :name => 'Eltopia'
)

z99335 = Domain.create!(
  :identifier => 99335,
  :name => 'Kahlotus'
)

z99343 = Domain.create!(
  :identifier => 99343,
  :name => 'Mesa'
)

z99347 = Domain.create!(
  :identifier => 99347,
  :name => 'Pomeroy'
)

z98823 = Domain.create!(
  :identifier => 98823,
  :name => 'Ephrata'
)

z98824 = Domain.create!(
  :identifier => 98824,
  :name => 'George'
)

z98832 = Domain.create!(
  :identifier => 98832,
  :name => 'Marlin'
)
...
z99321 = Domain.create!(
  :identifier => 99321,
  :name => 'Beverly'
)

z99349 = Domain.create!(
  :identifier => 99349,
  :name => 'Mattawa'
)
...
z98541 = Domain.create!(
  :identifier => 98541,
  :name => 'Elma'
)

z98547 = Domain.create!(
  :identifier => 98547,
  :name => 'Grayland'
)

z98550 = Domain.create!(
  :identifier => 98550,
  :name => 'Hoquiam'
)

z98552 = Domain.create!(
  :identifier => 98552,
  :name => 'Humptulips'
)

z98557 = Domain.create!(
  :identifier => 98557,
  :name => 'Mccleary'
)

z98559 = Domain.create!(
  :identifier => 98559,
  :name => 'Malone'
)

z98562 = Domain.create!(
  :identifier => 98562,
  :name => 'Moclips'
)

z98563 = Domain.create!(
  :identifier => 98563,
  :name => 'Montesano'
)

z98566 = Domain.create!(
  :identifier => 98566,
  :name => 'Neilton'
)

z98568 = Domain.create!(
  :identifier => 98568,
  :name => 'Oakville'
)
...
z98583 = Domain.create!(
  :identifier => 98583,
  :name => 'Satsop'
)

z98587 = Domain.create!(
  :identifier => 98587,
  :name => 'Taholah'
)

z98595 = Domain.create!(
  :identifier => 98595,
  :name => 'Westport'
)

z98236 = Domain.create!(
  :identifier => 98236,
  :name => 'Clinton'
)

z98239 = Domain.create!(
  :identifier => 98239,
  :name => 'Coupeville'
)

z98249 = Domain.create!(
  :identifier => 98249,
  :name => 'Freeland'
)

z98253 = Domain.create!(
  :identifier => 98253,
  :name => 'Greenbank'
)

z98260 = Domain.create!(
  :identifier => 98260,
  :name => 'Langley'
)
...
z98001 = Domain.create!(
  :identifier => 98001,
  :name => 'Auburn'
)

z98002 = Domain.create!(
  :identifier => 98002,
  :name => 'Auburn'
)
...
z98005 = Domain.create!(
  :identifier => 98005,
  :name => 'Bellevue'
)

z98006 = Domain.create!(
  :identifier => 98006,
  :name => 'Bellevue'
)

z98007 = Domain.create!(
  :identifier => 98007,
  :name => 'Bellevue'
)

z98008 = Domain.create!(
  :identifier => 98008,
  :name => 'Bellevue'
)

z98009 = Domain.create!(
  :identifier => 98009,
  :name => 'Bellevue'
)
...
z98013 = Domain.create!(
  :identifier => 98013,
  :name => 'Burton'
)

z98014 = Domain.create!(
  :identifier => 98014,
  :name => 'Carnation'
)

z98015 = Domain.create!(
  :identifier => 98015,
  :name => 'Bellevue'
)

z98019 = Domain.create!(
  :identifier => 98019,
  :name => 'Duvall'
)

z98022 = Domain.create!(
  :identifier => 98022,
  :name => 'Enumclaw'
)
...
z98027 = Domain.create!(
  :identifier => 98027,
  :name => 'Issaquah'
)

z98028 = Domain.create!(
  :identifier => 98028,
  :name => 'Kenmore'
)

z98029 = Domain.create!(
  :identifier => 98029,
  :name => 'Issaquah'
)

z98030 = Domain.create!(
  :identifier => 98030,
  :name => 'Kent'
)

z98031 = Domain.create!(
  :identifier => 98031,
  :name => 'Kent'
)

z98032 = Domain.create!(
  :identifier => 98032,
  :name => 'Kent'
)

z98033 = Domain.create!(
  :identifier => 98033,
  :name => 'Kirkland'
)

z98034 = Domain.create!(
  :identifier => 98034,
  :name => 'Kirkland'
)

z98035 = Domain.create!(
  :identifier => 98035,
  :name => 'Kent'
)
...
z98042 = Domain.create!(
  :identifier => 98042,
  :name => 'Kent'
)

z98045 = Domain.create!(
  :identifier => 98045,
  :name => 'North Bend'
)

z98047 = Domain.create!(
  :identifier => 98047,
  :name => 'Pacific'
)

z98050 = Domain.create!(
  :identifier => 98050,
  :name => 'Preston'
)

z98051 = Domain.create!(
  :identifier => 98051,
  :name => 'Ravensdale'
)

z98052 = Domain.create!(
  :identifier => 98052,
  :name => 'Redmond'
)

z98053 = Domain.create!(
  :identifier => 98053,
  :name => 'Redmond'
)

z98054 = Domain.create!(
  :identifier => 98054,
  :name => 'Redondo'
)

z98055 = Domain.create!(
  :identifier => 98055,
  :name => 'Renton'
)

z98056 = Domain.create!(
  :identifier => 98056,
  :name => 'Renton'
)

z98057 = Domain.create!(
  :identifier => 98057,
  :name => 'Renton'
)

z98058 = Domain.create!(
  :identifier => 98058,
  :name => 'Renton'
)

z98059 = Domain.create!(
  :identifier => 98059,
  :name => 'Renton'
)

z98062 = Domain.create!(
  :identifier => 98062,
  :name => 'Seahurst'
)
...
z98065 = Domain.create!(
  :identifier => 98065,
  :name => 'Snoqualmie'
)

z98070 = Domain.create!(
  :identifier => 98070,
  :name => 'Vashon'
)

z98071 = Domain.create!(
  :identifier => 98071,
  :name => 'Auburn'
)

z98072 = Domain.create!(
  :identifier => 98072,
  :name => 'Woodinville'
)

z98073 = Domain.create!(
  :identifier => 98073,
  :name => 'Redmond'
)

z98074 = Domain.create!(
  :identifier => 98074,
  :name => 'Sammamish'
)

z98075 = Domain.create!(
  :identifier => 98075,
  :name => 'Sammamish'
)

z98077 = Domain.create!(
  :identifier => 98077,
  :name => 'Woodinville'
)

z98083 = Domain.create!(
  :identifier => 98083,
  :name => 'Kirkland'
)

z98089 = Domain.create!(
  :identifier => 98089,
  :name => 'Kent'
)

z98092 = Domain.create!(
  :identifier => 98092,
  :name => 'Auburn'
)
...
z98102 = Domain.create!(
  :identifier => 98102,
  :name => 'Seattle'
)

z98103 = Domain.create!(
  :identifier => 98103,
  :name => 'Seattle'
)

z98104 = Domain.create!(
  :identifier => 98104,
  :name => 'Seattle'
)

z98105 = Domain.create!(
  :identifier => 98105,
  :name => 'Seattle'
)

z98106 = Domain.create!(
  :identifier => 98106,
  :name => 'Seattle'
)

z98107 = Domain.create!(
  :identifier => 98107,
  :name => 'Seattle'
)

z98108 = Domain.create!(
  :identifier => 98108,
  :name => 'Seattle'
)

z98109 = Domain.create!(
  :identifier => 98109,
  :name => 'Seattle'
)

z98111 = Domain.create!(
  :identifier => 98111,
  :name => 'Seattle'
)

z98112 = Domain.create!(
  :identifier => 98112,
  :name => 'Seattle'
)

z98113 = Domain.create!(
  :identifier => 98113,
  :name => 'Seattle'
)

z98114 = Domain.create!(
  :identifier => 98114,
  :name => 'Seattle'
)

z98115 = Domain.create!(
  :identifier => 98115,
  :name => 'Seattle'
)

z98116 = Domain.create!(
  :identifier => 98116,
  :name => 'Seattle'
)

z98117 = Domain.create!(
  :identifier => 98117,
  :name => 'Seattle'
)

z98118 = Domain.create!(
  :identifier => 98118,
  :name => 'Seattle'
)

z98119 = Domain.create!(
  :identifier => 98119,
  :name => 'Seattle'
)

z98121 = Domain.create!(
  :identifier => 98121,
  :name => 'Seattle'
)

z98122 = Domain.create!(
  :identifier => 98122,
  :name => 'Seattle'
)

z98124 = Domain.create!(
  :identifier => 98124,
  :name => 'Seattle'
)

z98125 = Domain.create!(
  :identifier => 98125,
  :name => 'Seattle'
)

z98126 = Domain.create!(
  :identifier => 98126,
  :name => 'Seattle'
)

z98127 = Domain.create!(
  :identifier => 98127,
  :name => 'Seattle'
)

z98129 = Domain.create!(
  :identifier => 98129,
  :name => 'Seattle'
)

z98131 = Domain.create!(
  :identifier => 98131,
  :name => 'Seattle'
)

z98132 = Domain.create!(
  :identifier => 98132,
  :name => 'Seattle'
)

z98133 = Domain.create!(
  :identifier => 98133,
  :name => 'Seattle'
)

z98134 = Domain.create!(
  :identifier => 98134,
  :name => 'Seattle'
)

z98136 = Domain.create!(
  :identifier => 98136,
  :name => 'Seattle'
)

z98138 = Domain.create!(
  :identifier => 98138,
  :name => 'Seattle'
)

z98139 = Domain.create!(
  :identifier => 98139,
  :name => 'Seattle'
)

z98141 = Domain.create!(
  :identifier => 98141,
  :name => 'Seattle'
)

z98144 = Domain.create!(
  :identifier => 98144,
  :name => 'Seattle'
)

z98145 = Domain.create!(
  :identifier => 98145,
  :name => 'Seattle'
)

z98146 = Domain.create!(
  :identifier => 98146,
  :name => 'Seattle'
)

z98148 = Domain.create!(
  :identifier => 98148,
  :name => 'Seattle'
)

z98151 = Domain.create!(
  :identifier => 98151,
  :name => 'Seattle'
)

z98154 = Domain.create!(
  :identifier => 98154,
  :name => 'Seattle'
)

z98155 = Domain.create!(
  :identifier => 98155,
  :name => 'Seattle'
)

z98158 = Domain.create!(
  :identifier => 98158,
  :name => 'Seattle'
)

z98160 = Domain.create!(
  :identifier => 98160,
  :name => 'Seattle'
)

z98161 = Domain.create!(
  :identifier => 98161,
  :name => 'Seattle'
)

z98164 = Domain.create!(
  :identifier => 98164,
  :name => 'Seattle'
)

z98165 = Domain.create!(
  :identifier => 98165,
  :name => 'Seattle'
)

z98166 = Domain.create!(
  :identifier => 98166,
  :name => 'Seattle'
)

z98168 = Domain.create!(
  :identifier => 98168,
  :name => 'Seattle'
)

z98170 = Domain.create!(
  :identifier => 98170,
  :name => 'Seattle'
)

z98171 = Domain.create!(
  :identifier => 98171,
  :name => 'Seattle'
)

z98174 = Domain.create!(
  :identifier => 98174,
  :name => 'Seattle'
)

z98175 = Domain.create!(
  :identifier => 98175,
  :name => 'Seattle'
)

z98177 = Domain.create!(
  :identifier => 98177,
  :name => 'Seattle'
)

z98178 = Domain.create!(
  :identifier => 98178,
  :name => 'Seattle'
)

z98181 = Domain.create!(
  :identifier => 98181,
  :name => 'Seattle'
)

z98184 = Domain.create!(
  :identifier => 98184,
  :name => 'Seattle'
)

z98185 = Domain.create!(
  :identifier => 98185,
  :name => 'Seattle'
)

z98188 = Domain.create!(
  :identifier => 98188,
  :name => 'Seattle'
)

z98190 = Domain.create!(
  :identifier => 98190,
  :name => 'Seattle'
)

z98191 = Domain.create!(
  :identifier => 98191,
  :name => 'Seattle'
)

z98194 = Domain.create!(
  :identifier => 98194,
  :name => 'Seattle'
)

z98195 = Domain.create!(
  :identifier => 98195,
  :name => 'Seattle'
)

z98198 = Domain.create!(
  :identifier => 98198,
  :name => 'Seattle'
)

z98199 = Domain.create!(
  :identifier => 98199,
  :name => 'Seattle'
)

z98224 = Domain.create!(
  :identifier => 98224,
  :name => 'Baring'
)

z98288 = Domain.create!(
  :identifier => 98288,
  :name => 'Skykomish'
)

z98061 = Domain.create!(
  :identifier => 98061,
  :name => 'Rollingbay'
)
...
z98311 = Domain.create!(
  :identifier => 98311,
  :name => 'Bremerton'
)

z98312 = Domain.create!(
  :identifier => 98312,
  :name => 'Bremerton'
)

z98314 = Domain.create!(
  :identifier => 98314,
  :name => 'Bremerton'
)

z98315 = Domain.create!(
  :identifier => 98315,
  :name => 'Silverdale'
)

z98322 = Domain.create!(
  :identifier => 98322,
  :name => 'Burley'
)

z98337 = Domain.create!(
  :identifier => 98337,
  :name => 'Bremerton'
)

z98340 = Domain.create!(
  :identifier => 98340,
  :name => 'Hansville'
)

z98342 = Domain.create!(
  :identifier => 98342,
  :name => 'Indianola'
)

z98345 = Domain.create!(
  :identifier => 98345,
  :name => 'Keyport'
)

z98346 = Domain.create!(
  :identifier => 98346,
  :name => 'Kingston'
)

z98353 = Domain.create!(
  :identifier => 98353,
  :name => 'Manchester'
)

z98359 = Domain.create!(
  :identifier => 98359,
  :name => 'Olalla'
)
...
z98378 = Domain.create!(
  :identifier => 98378,
  :name => 'Retsil'
)

z98380 = Domain.create!(
  :identifier => 98380,
  :name => 'Seabeck'
)

z98383 = Domain.create!(
  :identifier => 98383,
  :name => 'Silverdale'
)
...
z98392 = Domain.create!(
  :identifier => 98392,
  :name => 'Suquamish'
)

z98393 = Domain.create!(
  :identifier => 98393,
  :name => 'Tracyton'
)
...
z98926 = Domain.create!(
  :identifier => 98926,
  :name => 'Ellensburg'
)

z98934 = Domain.create!(
  :identifier => 98934,
  :name => 'Kittitas'
)

z98940 = Domain.create!(
  :identifier => 98940,
  :name => 'Ronald'
)

z98941 = Domain.create!(
  :identifier => 98941,
  :name => 'Roslyn'
)
...
z98950 = Domain.create!(
  :identifier => 98950,
  :name => 'Vantage'
)

z98602 = Domain.create!(
  :identifier => 98602,
  :name => 'Appleton'
)

z98605 = Domain.create!(
  :identifier => 98605,
  :name => 'Bingen'
)

z98613 = Domain.create!(
  :identifier => 98613,
  :name => 'Centerville'
)

z98617 = Domain.create!(
  :identifier => 98617,
  :name => 'Dallesport'
)

z98619 = Domain.create!(
  :identifier => 98619,
  :name => 'Glenwood'
)

z98620 = Domain.create!(
  :identifier => 98620,
  :name => 'Goldendale'
)

z98623 = Domain.create!(
  :identifier => 98623,
  :name => 'Husum'
)

z98628 = Domain.create!(
  :identifier => 98628,
  :name => 'Klickitat'
)

z98635 = Domain.create!(
  :identifier => 98635,
  :name => 'Lyle'
)
...
z98672 = Domain.create!(
  :identifier => 98672,
  :name => 'White Salmon'
)

z98673 = Domain.create!(
  :identifier => 98673,
  :name => 'Wishram'
)

z99322 = Domain.create!(
  :identifier => 99322,
  :name => 'Bickleton'
)

z99356 = Domain.create!(
  :identifier => 99356,
  :name => 'Roosevelt'
)

z98336 = Domain.create!(
  :identifier => 98336,
  :name => 'Glenoma'
)

z98355 = Domain.create!(
  :identifier => 98355,
  :name => 'Mineral'
)

z98356 = Domain.create!(
  :identifier => 98356,
  :name => 'Morton'
)

z98361 = Domain.create!(
  :identifier => 98361,
  :name => 'Packwood'
)

z98377 = Domain.create!(
  :identifier => 98377,
  :name => 'Randle'
)

z98522 = Domain.create!(
  :identifier => 98522,
  :name => 'Adna'
)

z98531 = Domain.create!(
  :identifier => 98531,
  :name => 'Centralia'
)

z98532 = Domain.create!(
  :identifier => 98532,
  :name => 'Chehalis'
)

z98533 = Domain.create!(
  :identifier => 98533,
  :name => 'Cinebar'
)

z98538 = Domain.create!(
  :identifier => 98538,
  :name => 'Curtis'
)

z98539 = Domain.create!(
  :identifier => 98539,
  :name => 'Doty'
)

z98542 = Domain.create!(
  :identifier => 98542,
  :name => 'Ethel'
)

z98544 = Domain.create!(
  :identifier => 98544,
  :name => 'Galvin'
)

z98564 = Domain.create!(
  :identifier => 98564,
  :name => 'Mossyrock'
)

z98565 = Domain.create!(
  :identifier => 98565,
  :name => 'Napavine'
)

z98570 = Domain.create!(
  :identifier => 98570,
  :name => 'Onalaska'
)
...
z98593 = Domain.create!(
  :identifier => 98593,
  :name => 'Vader'
)

z98596 = Domain.create!(
  :identifier => 98596,
  :name => 'Winlock'
)

z99008 = Domain.create!(
  :identifier => 99008,
  :name => 'Edwall'
)

z99029 = Domain.create!(
  :identifier => 99029,
  :name => 'Reardan'
)

z99032 = Domain.create!(
  :identifier => 99032,
  :name => 'Sprague'
)

z99103 = Domain.create!(
  :identifier => 99103,
  :name => 'Almira'
)

z99117 = Domain.create!(
  :identifier => 99117,
  :name => 'Creston'
)

z99122 = Domain.create!(
  :identifier => 99122,
  :name => 'Davenport'
)

z99134 = Domain.create!(
  :identifier => 99134,
  :name => 'Harrington'
)

z99144 = Domain.create!(
  :identifier => 99144,
  :name => 'Lamona'
)

z99147 = Domain.create!(
  :identifier => 99147,
  :name => 'Lincoln'
)

z99154 = Domain.create!(
  :identifier => 99154,
  :name => 'Mohler'
)

z99159 = Domain.create!(
  :identifier => 99159,
  :name => 'Odessa'
)

z99185 = Domain.create!(
  :identifier => 99185,
  :name => 'Wilbur'
)

z98524 = Domain.create!(
  :identifier => 98524,
  :name => 'Allyn'
)

z98528 = Domain.create!(
  :identifier => 98528,
  :name => 'Belfair'
)

z98546 = Domain.create!(
  :identifier => 98546,
  :name => 'Grapeview'
)

z98548 = Domain.create!(
  :identifier => 98548,
  :name => 'Hoodsport'
)

z98555 = Domain.create!(
  :identifier => 98555,
  :name => 'Lilliwaup'
)

z98560 = Domain.create!(
  :identifier => 98560,
  :name => 'Matlock'
)

z98584 = Domain.create!(
  :identifier => 98584,
  :name => 'Shelton'
)

z98588 = Domain.create!(
  :identifier => 98588,
  :name => 'Tahuya'
)

z98592 = Domain.create!(
  :identifier => 98592,
  :name => 'Union'
)

z98812 = Domain.create!(
  :identifier => 98812,
  :name => 'Brewster'
)

z98814 = Domain.create!(
  :identifier => 98814,
  :name => 'Carlton'
)

z98819 = Domain.create!(
  :identifier => 98819,
  :name => 'Conconully'
)

z98827 = Domain.create!(
  :identifier => 98827,
  :name => 'Loomis'
)

z98829 = Domain.create!(
  :identifier => 98829,
  :name => 'Malott'
)

z98833 = Domain.create!(
  :identifier => 98833,
  :name => 'Mazama'
)

z98834 = Domain.create!(
  :identifier => 98834,
  :name => 'Methow'
)

z98840 = Domain.create!(
  :identifier => 98840,
  :name => 'Okanogan'
)

z98841 = Domain.create!(
  :identifier => 98841,
  :name => 'Omak'
)

z98844 = Domain.create!(
  :identifier => 98844,
  :name => 'Oroville'
)

z98846 = Domain.create!(
  :identifier => 98846,
  :name => 'Pateros'
)

z98849 = Domain.create!(
  :identifier => 98849,
  :name => 'Riverside'
)

z98855 = Domain.create!(
  :identifier => 98855,
  :name => 'Tonasket'
)

z98856 = Domain.create!(
  :identifier => 98856,
  :name => 'Twisp'
)

z98859 = Domain.create!(
  :identifier => 98859,
  :name => 'Wauconda'
)

z98862 = Domain.create!(
  :identifier => 98862,
  :name => 'Winthrop'
)

z99116 = Domain.create!(
  :identifier => 99116,
  :name => 'Coulee dam'
)

z99124 = Domain.create!(
  :identifier => 99124,
  :name => 'Elmer city'
)

z99155 = Domain.create!(
  :identifier => 99155,
  :name => 'Nespelem'
)

z98527 = Domain.create!(
  :identifier => 98527,
  :name => 'Bay center'
)

z98554 = Domain.create!(
  :identifier => 98554,
  :name => 'Lebam'
)

z98561 = Domain.create!(
  :identifier => 98561,
  :name => 'Menlo'
)

z98577 = Domain.create!(
  :identifier => 98577,
  :name => 'Raymond'
)

z98586 = Domain.create!(
  :identifier => 98586,
  :name => 'South bend'
)

z98590 = Domain.create!(
  :identifier => 98590,
  :name => 'Tokeland'
)

z98614 = Domain.create!(
  :identifier => 98614,
  :name => 'Chinook'
)

z98624 = Domain.create!(
  :identifier => 98624,
  :name => 'Ilwaco'
)

z98631 = Domain.create!(
  :identifier => 98631,
  :name => 'Long beach'
)

z98637 = Domain.create!(
  :identifier => 98637,
  :name => 'Nahcotta'
)

z98638 = Domain.create!(
  :identifier => 98638,
  :name => 'Naselle'
)
...
z98644 = Domain.create!(
  :identifier => 98644,
  :name => 'Seaview'
)

z99119 = Domain.create!(
  :identifier => 99119,
  :name => 'Cusick'
)

z99139 = Domain.create!(
  :identifier => 99139,
  :name => 'Ione'
)

z99152 = Domain.create!(
  :identifier => 99152,
  :name => 'Metaline'
)
...
z98321 = Domain.create!(
  :identifier => 98321,
  :name => 'Buckley'
)

z98323 = Domain.create!(
  :identifier => 98323,
  :name => 'Carbonado'
)

z98327 = Domain.create!(
  :identifier => 98327,
  :name => 'Dupont'
)

z98328 = Domain.create!(
  :identifier => 98328,
  :name => 'Eatonville'
)
...
z98351 = Domain.create!(
  :identifier => 98351,
  :name => 'Longbranch'
)

z98352 = Domain.create!(
  :identifier => 98352,
  :name => 'Sumner'
)

z98354 = Domain.create!(
  :identifier => 98354,
  :name => 'Milton'
)

z98360 = Domain.create!(
  :identifier => 98360,
  :name => 'Orting'
)

z98371 = Domain.create!(
  :identifier => 98371,
  :name => 'Puyallup'
)

z98372 = Domain.create!(
  :identifier => 98372,
  :name => 'Puyallup'
)

z98373 = Domain.create!(
  :identifier => 98373,
  :name => 'Puyallup'
)

z98374 = Domain.create!(
  :identifier => 98374,
  :name => 'Puyallup'
)

z98375 = Domain.create!(
  :identifier => 98375,
  :name => 'Puyallup'
)
...
z98388 = Domain.create!(
  :identifier => 98388,
  :name => 'Steilacoom'
)

z98390 = Domain.create!(
  :identifier => 98390,
  :name => 'Sumner'
)
...
z98395 = Domain.create!(
  :identifier => 98395,
  :name => 'Wauna'
)

z98396 = Domain.create!(
  :identifier => 98396,
  :name => 'Wilkeson'
)

z98397 = Domain.create!(
  :identifier => 98397,
  :name => 'Longmire'
)
...
z98402 = Domain.create!(
  :identifier => 98402,
  :name => 'Tacoma'
)

z98403 = Domain.create!(
  :identifier => 98403,
  :name => 'Tacoma'
)

z98404 = Domain.create!(
  :identifier => 98404,
  :name => 'Tacoma'
)

z98405 = Domain.create!(
  :identifier => 98405,
  :name => 'Tacoma'
)

z98406 = Domain.create!(
  :identifier => 98406,
  :name => 'Tacoma'
)

z98407 = Domain.create!(
  :identifier => 98407,
  :name => 'Tacoma'
)

z98408 = Domain.create!(
  :identifier => 98408,
  :name => 'Tacoma'
)

z98409 = Domain.create!(
  :identifier => 98409,
  :name => 'Tacoma'
)

z98411 = Domain.create!(
  :identifier => 98411,
  :name => 'Tacoma'
)

z98412 = Domain.create!(
  :identifier => 98412,
  :name => 'Tacoma'
)

z98413 = Domain.create!(
  :identifier => 98413,
  :name => 'Tacoma'
)

z98415 = Domain.create!(
  :identifier => 98415,
  :name => 'Tacoma'
)

z98416 = Domain.create!(
  :identifier => 98416,
  :name => 'Tacoma'
)

z98417 = Domain.create!(
  :identifier => 98417,
  :name => 'Tacoma'
)

z98418 = Domain.create!(
  :identifier => 98418,
  :name => 'Tacoma'
)

z98419 = Domain.create!(
  :identifier => 98419,
  :name => 'Tacoma'
)

z98421 = Domain.create!(
  :identifier => 98421,
  :name => 'Tacoma'
)

z98422 = Domain.create!(
  :identifier => 98422,
  :name => 'Tacoma'
)

z98424 = Domain.create!(
  :identifier => 98424,
  :name => 'Tacoma'
)
...
z98442 = Domain.create!(
  :identifier => 98442,
  :name => 'Tacoma'
)

z98443 = Domain.create!(
  :identifier => 98443,
  :name => 'Tacoma'
)

z98444 = Domain.create!(
  :identifier => 98444,
  :name => 'Tacoma'
)

z98445 = Domain.create!(
  :identifier => 98445,
  :name => 'Tacoma'
)

z98446 = Domain.create!(
  :identifier => 98446,
  :name => 'Tacoma'
)

z98447 = Domain.create!(
  :identifier => 98447,
  :name => 'Tacoma'
)

z98448 = Domain.create!(
  :identifier => 98448,
  :name => 'Tacoma'
)

z98450 = Domain.create!(
  :identifier => 98450,
  :name => 'Tacoma'
)

z98455 = Domain.create!(
  :identifier => 98455,
  :name => 'Tacoma'
)

z98460 = Domain.create!(
  :identifier => 98460,
  :name => 'Tacoma'
)

z98464 = Domain.create!(
  :identifier => 98464,
  :name => 'Tacoma'
)

z98465 = Domain.create!(
  :identifier => 98465,
  :name => 'Tacoma'
)

z98466 = Domain.create!(
  :identifier => 98466,
  :name => 'Tacoma'
)
...
z98477 = Domain.create!(
  :identifier => 98477,
  :name => 'Tacoma'
)

z98481 = Domain.create!(
  :identifier => 98481,
  :name => 'Tacoma'
)

z98490 = Domain.create!(
  :identifier => 98490,
  :name => 'Tacoma'
)

z98492 = Domain.create!(
  :identifier => 98492,
  :name => 'Lakewood'
)

z98493 = Domain.create!(
  :identifier => 98493,
  :name => 'Tacoma'
)

z98496 = Domain.create!(
  :identifier => 98496,
  :name => 'Lakewood'
)

z98497 = Domain.create!(
  :identifier => 98497,
  :name => 'Lakewood'
)

z98498 = Domain.create!(
  :identifier => 98498,
  :name => 'Lakewood'
)

z98499 = Domain.create!(
  :identifier => 98499,
  :name => 'Lakewood'
)

z98558 = Domain.create!(
  :identifier => 98558,
  :name => 'Mckenna'
)

z98580 = Domain.create!(
  :identifier => 98580,
  :name => 'Roy'
)
...
z98221 = Domain.create!(
  :identifier => 98221,
  :name => 'Anacortes'
)

z98232 = Domain.create!(
  :identifier => 98232,
  :name => 'Bow'
)

z98233 = Domain.create!(
  :identifier => 98233,
  :name => 'Burlington'
)

z98235 = Domain.create!(
  :identifier => 98235,
  :name => 'Clearlake'
)

z98237 = Domain.create!(
  :identifier => 98237,
  :name => 'Concrete'
)

z98238 = Domain.create!(
  :identifier => 98238,
  :name => 'Conway'
)

z98255 = Domain.create!(
  :identifier => 98255,
  :name => 'Hamilton'
)
...
z98639 = Domain.create!(
  :identifier => 98639,
  :name => 'North Bonneville'
)

z98648 = Domain.create!(
  :identifier => 98648,
  :name => 'Stevenson'
)

z98651 = Domain.create!(
  :identifier => 98651,
  :name => 'Underwood'
)

z98012 = Domain.create!(
  :identifier => 98012,
  :name => 'Bothell'
)

z98020 = Domain.create!(
  :identifier => 98020,
  :name => 'Edmonds'
)

z98021 = Domain.create!(
  :identifier => 98021,
  :name => 'Bothell'
)

z98026 = Domain.create!(
  :identifier => 98026,
  :name => 'Edmonds'
)

z98036 = Domain.create!(
  :identifier => 98036,
  :name => 'Lynnwood'
)

z98037 = Domain.create!(
  :identifier => 98037,
  :name => 'Lynnwood'
)

z98043 = Domain.create!(
  :identifier => 98043,
  :name => 'Mountlake Terrace'
)

z98046 = Domain.create!(
  :identifier => 98046,
  :name => 'Lynnwood'
)

z98082 = Domain.create!(
  :identifier => 98082,
  :name => 'Mill Creek'
)

z98087 = Domain.create!(
  :identifier => 98087,
  :name => 'Lynnwood'
)

z98201 = Domain.create!(
  :identifier => 98201,
  :name => 'Everett'
)

z98203 = Domain.create!(
  :identifier => 98203,
  :name => 'Everett'
)

z98204 = Domain.create!(
  :identifier => 98204,
  :name => 'Everett'
)

z98205 = Domain.create!(
  :identifier => 98205,
  :name => 'Everett'
)

z98206 = Domain.create!(
  :identifier => 98206,
  :name => 'Everett'
)

z98207 = Domain.create!(
  :identifier => 98207,
  :name => 'Everett'
)

z98208 = Domain.create!(
  :identifier => 98208,
  :name => 'Everett'
)

z98213 = Domain.create!(
  :identifier => 98213,
  :name => 'Everett'
)

z98223 = Domain.create!(
  :identifier => 98223,
  :name => 'Arlington'
)

z98241 = Domain.create!(
  :identifier => 98241,
  :name => 'Darrington'
)

z98251 = Domain.create!(
  :identifier => 98251,
  :name => 'Gold Bar'
)

z98252 = Domain.create!(
  :identifier => 98252,
  :name => 'Granite Falls'
)

z98256 = Domain.create!(
  :identifier => 98256,
  :name => 'Index'
)

z98258 = Domain.create!(
  :identifier => 98258,
  :name => 'Lake Stevens'
)

z98259 = Domain.create!(
  :identifier => 98259,
  :name => 'North Lakewood'
)

z98270 = Domain.create!(
  :identifier => 98270,
  :name => 'Marysville'
)

z98271 = Domain.create!(
  :identifier => 98271,
  :name => 'Marysville'
)

z98272 = Domain.create!(
  :identifier => 98272,
  :name => 'Monroe'
)

z98275 = Domain.create!(
  :identifier => 98275,
  :name => 'Mukilteo'
)

z98287 = Domain.create!(
  :identifier => 98287,
  :name => 'Silvana'
)

z98290 = Domain.create!(
  :identifier => 98290,
  :name => 'Snohomish'
)

z98291 = Domain.create!(
  :identifier => 98291,
  :name => 'Snohomish'
)

z98292 = Domain.create!(
  :identifier => 98292,
  :name => 'Stanwood'
)

z98293 = Domain.create!(
  :identifier => 98293,
  :name => 'Startup'
)

z98294 = Domain.create!(
  :identifier => 98294,
  :name => 'Sultan'
)

z98296 = Domain.create!(
  :identifier => 98296,
  :name => 'Snohomish'
)

z99001 = Domain.create!(
  :identifier => 99001,
  :name => 'Airway Heights'
)

z99003 = Domain.create!(
  :identifier => 99003,
  :name => 'Chattaroy'
)

z99004 = Domain.create!(
  :identifier => 99004,
  :name => 'Cheney'
)

z99005 = Domain.create!(
  :identifier => 99005,
  :name => 'Colbert'
)
...
z99011 = Domain.create!(
  :identifier => 99011,
  :name => 'Fairchild Air Force Base'
)

z99012 = Domain.create!(
  :identifier => 99012,
  :name => 'Fairfield'
)

z99014 = Domain.create!(
  :identifier => 99014,
  :name => 'Four Lakes'
)

z99016 = Domain.create!(
  :identifier => 99016,
  :name => 'Greenacres'
)

z99018 = Domain.create!(
  :identifier => 99018,
  :name => 'Latah'
)

z99019 = Domain.create!(
  :identifier => 99019,
  :name => 'Liberty Lake'
)

z99020 = Domain.create!(
  :identifier => 99020,
  :name => 'Marshall'
)

z99021 = Domain.create!(
  :identifier => 99021,
  :name => 'Mead'
)

z99022 = Domain.create!(
  :identifier => 99022,
  :name => 'Medical Lake'
)

z99023 = Domain.create!(
  :identifier => 99023,
  :name => 'Mica'
)

z99025 = Domain.create!(
  :identifier => 99025,
  :name => 'Newman Lake'
)

z99026 = Domain.create!(
  :identifier => 99026,
  :name => 'Nine Mile Falls'
)

z99027 = Domain.create!(
  :identifier => 99027,
  :name => 'Otis Orchards'
)

z99030 = Domain.create!(
  :identifier => 99030,
  :name => 'Rockford'
)

z99031 = Domain.create!(
  :identifier => 99031,
  :name => 'Spangle'
)

z99036 = Domain.create!(
  :identifier => 99036,
  :name => 'Valleyford'
)

z99037 = Domain.create!(
  :identifier => 99037,
  :name => 'Veradale'
)

z99039 = Domain.create!(
  :identifier => 99039,
  :name => 'Waverly'
)

z99201 = Domain.create!(
  :identifier => 99201,
  :name => 'Spokane'
)

z99202 = Domain.create!(
  :identifier => 99202,
  :name => 'Spokane'
)

z99203 = Domain.create!(
  :identifier => 99203,
  :name => 'Spokane'
)

z99204 = Domain.create!(
  :identifier => 99204,
  :name => 'Spokane'
)

z99205 = Domain.create!(
  :identifier => 99205,
  :name => 'Spokane'
)

z99206 = Domain.create!(
  :identifier => 99206,
  :name => 'Spokane'
)

z99207 = Domain.create!(
  :identifier => 99207,
  :name => 'Spokane'
)

z99208 = Domain.create!(
  :identifier => 99208,
  :name => 'Spokane'
)

z99209 = Domain.create!(
  :identifier => 99209,
  :name => 'Spokane'
)

z99210 = Domain.create!(
  :identifier => 99210,
  :name => 'Spokane'
)

z99211 = Domain.create!(
  :identifier => 99211,
  :name => 'Spokane'
)

z99212 = Domain.create!(
  :identifier => 99212,
  :name => 'Spokane'
)

z99213 = Domain.create!(
  :identifier => 99213,
  :name => 'Spokane'
)

z99214 = Domain.create!(
  :identifier => 99214,
  :name => 'Spokane'
)

z99215 = Domain.create!(
  :identifier => 99215,
  :name => 'Spokane'
)

z99216 = Domain.create!(
  :identifier => 99216,
  :name => 'Spokane'
)

z99217 = Domain.create!(
  :identifier => 99217,
  :name => 'Spokane'
)

z99218 = Domain.create!(
  :identifier => 99218,
  :name => 'Spokane'
)

z99219 = Domain.create!(
  :identifier => 99219,
  :name => 'Spokane'
)

z99220 = Domain.create!(
  :identifier => 99220,
  :name => 'Spokane'
)

z99223 = Domain.create!(
  :identifier => 99223,
  :name => 'Spokane'
)

z99224 = Domain.create!(
  :identifier => 99224,
  :name => 'Spokane'
)

z99228 = Domain.create!(
  :identifier => 99228,
  :name => 'Spokane'
)

z99251 = Domain.create!(
  :identifier => 99251,
  :name => 'Spokane'
)

z99252 = Domain.create!(
  :identifier => 99252,
  :name => 'Spokane'
)

z99256 = Domain.create!(
  :identifier => 99256,
  :name => 'Spokane'
)

z99258 = Domain.create!(
  :identifier => 99258,
  :name => 'Spokane'
)

z99260 = Domain.create!(
  :identifier => 99260,
  :name => 'Spokane'
)

z99299 = Domain.create!(
  :identifier => 99299,
  :name => 'Spokane'
)

z99013 = Domain.create!(
  :identifier => 99013,
  :name => 'Ford'
)

z99034 = Domain.create!(
  :identifier => 99034,
  :name => 'Tumtum'
)

z99040 = Domain.create!(
  :identifier => 99040,
  :name => 'Wellpinit'
)

z99101 = Domain.create!(
  :identifier => 99101,
  :name => 'Addy'
)

z99109 = Domain.create!(
  :identifier => 99109,
  :name => 'Chewelah'
)

z99110 = Domain.create!(
  :identifier => 99110,
  :name => 'Clayton'
)

z99114 = Domain.create!(
  :identifier => 99114,
  :name => 'Colville'
)

z99126 = Domain.create!(
  :identifier => 99126,
  :name => 'Evans'
)

z99129 = Domain.create!(
  :identifier => 99129,
  :name => 'Fruitland'
)

z99131 = Domain.create!(
  :identifier => 99131,
  :name => 'Gifford'
)

z99137 = Domain.create!(
  :identifier => 99137,
  :name => 'Hunters'
)

z99141 = Domain.create!(
  :identifier => 99141,
  :name => 'Kettle Falls'
)

z99148 = Domain.create!(
  :identifier => 99148,
  :name => 'Loon Lake'
)

z99151 = Domain.create!(
  :identifier => 99151,
  :name => 'Marcus'
)

z99157 = Domain.create!(
  :identifier => 99157,
  :name => 'Northport'
)

z99167 = Domain.create!(
  :identifier => 99167,
  :name => 'Rice'
)

z99173 = Domain.create!(
  :identifier => 99173,
  :name => 'Springdale'
)

z99181 = Domain.create!(
  :identifier => 99181,
  :name => 'Valley'
)

z98501 = Domain.create!(
  :identifier => 98501,
  :name => 'Olympia'
)

z98502 = Domain.create!(
  :identifier => 98502,
  :name => 'Olympia'
)

z98503 = Domain.create!(
  :identifier => 98503,
  :name => 'Lacey'
)

z98504 = Domain.create!(
  :identifier => 98504,
  :name => 'Olympia'
)

z98505 = Domain.create!(
  :identifier => 98505,
  :name => 'Olympia'
)

z98506 = Domain.create!(
  :identifier => 98506,
  :name => 'Olympia'
)

z98507 = Domain.create!(
  :identifier => 98507,
  :name => 'Olympia'
)

z98508 = Domain.create!(
  :identifier => 98508,
  :name => 'Olympia'
)

z98509 = Domain.create!(
  :identifier => 98509,
  :name => 'Lacey'
)

z98511 = Domain.create!(
  :identifier => 98511,
  :name => 'Tumwater'
)

z98512 = Domain.create!(
  :identifier => 98512,
  :name => 'Olympia'
)

z98513 = Domain.create!(
  :identifier => 98513,
  :name => 'Olympia'
)

z98516 = Domain.create!(
  :identifier => 98516,
  :name => 'Olympia'
)

z98530 = Domain.create!(
  :identifier => 98530,
  :name => 'Bucoda'
)

z98540 = Domain.create!(
  :identifier => 98540,
  :name => 'East Olympia'
)

z98556 = Domain.create!(
  :identifier => 98556,
  :name => 'Littlerock'
)

z98576 = Domain.create!(
  :identifier => 98576,
  :name => 'Rainier'
)

z98579 = Domain.create!(
  :identifier => 98579,
  :name => 'Rochester'
)

z98589 = Domain.create!(
  :identifier => 98589,
  :name => 'Tenino'
)

z98597 = Domain.create!(
  :identifier => 98597,
  :name => 'Yelm'
)

z98599 = Domain.create!(
  :identifier => 98599,
  :name => 'Olympia'
)

z98612 = Domain.create!(
  :identifier => 98612,
  :name => 'Cathlamet'
)
...
z98647 = Domain.create!(
  :identifier => 98647,
  :name => 'Skamokawa'
)

z99323 = Domain.create!(
  :identifier => 99323,
  :name => 'Burbank'
)

z99324 = Domain.create!(
  :identifier => 99324,
  :name => 'College Place'
)

z99329 = Domain.create!(
  :identifier => 99329,
  :name => 'Dixie'
)

z99348 = Domain.create!(
  :identifier => 99348,
  :name => 'Prescott'
)

z99360 = Domain.create!(
  :identifier => 99360,
  :name => 'Touchet'
)

z99361 = Domain.create!(
  :identifier => 99361,
  :name => 'Waitsburg'
)

z99362 = Domain.create!(
  :identifier => 99362,
  :name => 'Walla Walla'
)

z99363 = Domain.create!(
  :identifier => 99363,
  :name => 'Wallula'
)

z98220 = Domain.create!(
  :identifier => 98220,
  :name => 'Acme'
)

z98225 = Domain.create!(
  :identifier => 98225,
  :name => 'Bellingham'
)

z98226 = Domain.create!(
  :identifier => 98226,
  :name => 'Bellingham'
)

z98227 = Domain.create!(
  :identifier => 98227,
  :name => 'Bellingham'
)

z98228 = Domain.create!(
  :identifier => 98228,
  :name => 'Bellingham'
)

z98229 = Domain.create!(
  :identifier => 98229,
  :name => 'Bellingham'
)

z98230 = Domain.create!(
  :identifier => 98230,
  :name => 'Blaine'
)

z98231 = Domain.create!(
  :identifier => 98231,
  :name => 'Blaine'
)

z98240 = Domain.create!(
  :identifier => 98240,
  :name => 'Custer'
)

z98244 = Domain.create!(
  :identifier => 98244,
  :name => 'Deming'
)

z98247 = Domain.create!(
  :identifier => 98247,
  :name => 'Everson'
)

z98248 = Domain.create!(
  :identifier => 98248,
  :name => 'Ferndale'
)

z98262 = Domain.create!(
  :identifier => 98262,
  :name => 'Lummi Island'
)

z98264 = Domain.create!(
  :identifier => 98264,
  :name => 'Lynden'
)
...
z98281 = Domain.create!(
  :identifier => 98281,
  :name => 'Point Roberts'
)

z98295 = Domain.create!(
  :identifier => 98295,
  :name => 'Sumas'
)

z99017 = Domain.create!(
  :identifier => 99017,
  :name => 'Lamont'
)

z99033 = Domain.create!(
  :identifier => 99033,
  :name => 'Tekoa'
)

z99102 = Domain.create!(
  :identifier => 99102,
  :name => 'Albion'
)

z99104 = Domain.create!(
  :identifier => 99104,
  :name => 'Belmont'
)

z99111 = Domain.create!(
  :identifier => 99111,
  :name => 'Colfax'
)

z99113 = Domain.create!(
  :identifier => 99113,
  :name => 'Colton'
)

z99125 = Domain.create!(
  :identifier => 99125,
  :name => 'Endicott'
)

z99128 = Domain.create!(
  :identifier => 99128,
  :name => 'Farmington'
)

z99130 = Domain.create!(
  :identifier => 99130,
  :name => 'Garfield'
)

z99136 = Domain.create!(
  :identifier => 99136,
  :name => 'Hay'
)
...
z99158 = Domain.create!(
  :identifier => 99158,
  :name => 'Oakesdale'
)

z99161 = Domain.create!(
  :identifier => 99161,
  :name => 'Palouse'
)

z99163 = Domain.create!(
  :identifier => 99163,
  :name => 'Pullman'
)

z99164 = Domain.create!(
  :identifier => 99164,
  :name => 'Pullman'
)

z99170 = Domain.create!(
  :identifier => 99170,
  :name => 'Rosalia'
)

z99171 = Domain.create!(
  :identifier => 99171,
  :name => 'Saint John'
)

z99174 = Domain.create!(
  :identifier => 99174,
  :name => 'Steptoe'
)

z99176 = Domain.create!(
  :identifier => 99176,
  :name => 'Thornton'
)

z99179 = Domain.create!(
  :identifier => 99179,
  :name => 'Uniontown'
)

z99333 = Domain.create!(
  :identifier => 99333,
  :name => 'Hooper'
)

z98901 = Domain.create!(
  :identifier => 98901,
  :name => 'Yakima'
)

z98902 = Domain.create!(
  :identifier => 98902,
  :name => 'Yakima'
)

z98903 = Domain.create!(
  :identifier => 98903,
  :name => 'Yakima'
)

z98904 = Domain.create!(
  :identifier => 98904,
  :name => 'Yakima'
)

z98907 = Domain.create!(
  :identifier => 98907,
  :name => 'Yakima'
)

z98908 = Domain.create!(
  :identifier => 98908,
  :name => 'Yakima'
)

z98909 = Domain.create!(
  :identifier => 98909,
  :name => 'Yakima'
)

z98920 = Domain.create!(
  :identifier => 98920,
  :name => 'Brownstown'
)

z98921 = Domain.create!(
  :identifier => 98921,
  :name => 'Buena'
)

z98923 = Domain.create!(
  :identifier => 98923,
  :name => 'Cowiche'
)

z98929 = Domain.create!(
  :identifier => 98929,
  :name => 'Goose Prairie'
)

z98930 = Domain.create!(
  :identifier => 98930,
  :name => 'Grandview'
)

z98932 = Domain.create!(
  :identifier => 98932,
  :name => 'Granger'
)

z98933 = Domain.create!(
  :identifier => 98933,
  :name => 'Harrah'
)

z98935 = Domain.create!(
  :identifier => 98935,
  :name => 'Mabton'
)

z98936 = Domain.create!(
  :identifier => 98936,
  :name => 'Moxee'
)

z98937 = Domain.create!(
  :identifier => 98937,
  :name => 'Naches'
)

z98938 = Domain.create!(
  :identifier => 98938,
  :name => 'Outlook'
)

z98939 = Domain.create!(
  :identifier => 98939,
  :name => 'Parker'
)

z98942 = Domain.create!(
  :identifier => 98942,
  :name => 'Selah'
)

z98944 = Domain.create!(
  :identifier => 98944,
  :name => 'Sunnyside'
)

z98947 = Domain.create!(
  :identifier => 98947,
  :name => 'Tieton'
)

z98948 = Domain.create!(
  :identifier => 98948,
  :name => 'Toppenish'
)

z98951 = Domain.create!(
  :identifier => 98951,
  :name => 'Wapato'
)

z98952 = Domain.create!(
  :identifier => 98952,
  :name => 'White Swan'
)

z98953 = Domain.create!(
  :identifier => 98953,
  :name => 'Zillah'
)
...
o3 = Option.create!(
  ...
  :category => 'Initiative',
  :designator => '1163',
  :long_description => '<b>The Law as it Presently Exists</b><br>
    Long-term care workers assist the elderly and persons with
    disabilities in the homes of the people they assist or through
    assisted living facilities, adult family homes, or state-licensed
    boarding homes. Assistance by long-term care workers may include
    help with eating, dressing, bathing, meal preparation, household
    chores, and other assistance with daily life. Long-term care
    workers might provide this assistance under a direct contract with
    the state as an individual provider, or they might be employees of
    home care agencies or other facilities. Long-term care workers
    include respite care providers, community residential service
    providers, and any other worker who directly provides home or
    community-based services to the elderly or persons with functional
    or developmental disabilities. Long-term care workers do not
    include employees of nursing homes, hospitals or other acute care
    facilities, adult day care centers, or adult day health
    providers. Long-term care workers are paid according to a
    collective bargaining agreement negotiated with the state, subject
    to legislative approval.<br> &nbsp;<br> State law currently
    requires that long-term care workers receive training. Additional
    requirements are scheduled to take effect in the future. Under
    current law, long-term care workers hired on or after January 1,
    2014, will be required to be certified by the state Department of
    Health as &ldquo;home care aides&rdquo; within 150 days of
    beginning work. To be certified, long-term care workers will need
    to complete specific training and pass an examination. The
    requirement that long-term care workers receive 35 hours of basic
    training will increase to a 75-hour requirement on January 1,
    2014. State law requires that the state pay for the training, and
    pay long-term care workers for the time they spend in
    training. After they are certified, long-term care workers hired
    after January 1, 2014, will be required to receive 12 hours of
    continuing training each year. There are reduced requirements for
    those who only provide care for their own adult children or
    parents. The state will also be required to offer advanced
    training to long-term care workers beginning January 1, 2014.<br>
    &nbsp;<br> State law also requires that long-term care workers
    receive criminal background checks. These checks determine whether
    long-term care workers have a criminal history that would
    disqualify them from working with vulnerable persons. These checks
    currently look only for criminal convictions in Washington. If the
    worker has lived in Washington less than three years, then a
    fingerprint-based check also is conducted through the Federal
    Bureau of Investigation (FBI). All long-term care workers hired
    after January 1, 2014, will be required to receive a
    fingerprint-based check through the FBI, no matter how long they
    have lived in Washington.<br> &nbsp;<br> <b>The Effect of the
    Proposed Measure, if Approved</b><br> Initiative Measure 1163
    would move up the date by which the additional training,
    certification, and background check requirements for long-term
    care workers take effect. The requirement that long-term care
    workers receive certification as &ldquo;home care aides,&rdquo;
    and receive additional training would apply to all long-term care
    workers hired on or after January 7, 2012, instead of January 1,
    2014. The requirement that long-term care workers receive criminal
    background checks through the FBI would apply to all long-term
    care workers hired on or after January 1, 2012, instead of January
    1, 2014. Community residential service providers would not be
    covered by these additional training, certification, and
    background check requirements until January 1, 2016. <br>
    &nbsp;<br> In addition, this measure would require that the state
    auditor conduct performance audits of the state&rsquo;s long-term
    in-home care program. The first audit would have to be completed
    within twelve months after this measure takes effect. The auditor
    would be required to conduct performance audits &ldquo;on a
    biannual basis thereafter.&rdquo; This measure would also require
    the state to hire five additional fraud investigators.<br>
    &nbsp;<br> This measure would require the state to limit its
    administrative expenses so that at least 90% of taxpayer spending
    on the long-term in-home care program is devoted to direct
    care. The state would be required to achieve this limitation
    within two years after this measure takes effect. This measure
    also provides that if the passage of this act triggers changes to
    any collective bargaining agreement, then those changes go into
    effect immediately without the need for legislative approval.<p>',
  :additional_details => '<p>Current law requires increased
    mandatory training, background checks and certification for
    long-term care workers, depending on worker classification,
    beginning Jan. 1, 2014. Initiative 1163 would require the
    training, background checks and certification for long-term care
    workers to begin Jan. 7, 2012, but delay these requirements for
    community residential providers until Jan 1, 2016. For the
    long-term in-home care program, administrative costs are capped
    and performance audits with additional fraud investigators are
    required. Over six fiscal years, costs are estimated to increase
    $31.3 million and revenue from the federal government and fees is
    estimated to increase $18.4 million.</p> <p> <b>General
    Assumptions</b> <br> The Washington State Office of Financial
    Management, in consultation with the Washington State Department
    of Social and Health Services (DSHS) and Department of Health
    (DOH), developed a model to estimate the costs and expenditures of
    implementing increased mandatory training, background checks and
    certification for long-term care workers. This model was first
    developed for the fiscal impact statement for Initiative 1029,
    passed in 2008, and subsequently used for fiscal notes on
    legislation, including Engrossed Substitute Senate Bill 6180
    (2009) and Engrossed Substitute House Bill 1548 (2011). This
    statement uses this model updated to the June 2011 Caseload
    Forecast Council forecast (forecast).</p> <p> The following
    assumptions are used to measure fiscal impacts: <ul> <li>Estimates
    are described using the state&#39;s fiscal year (FY) of July 1
    through June 30.</li> <li>The initiative applies prospectively
    with an implementation date of Jan. 7, 2012.</li> <li>Current law
    directs that increased mandatory training, background checks and
    certification for long-term care workers begin Jan. 1, 2014. The
    initiative would require training, background checks and
    certifications to begin Jan. 7, 2012, but delay the requirements
    for workers who are community residential service providers to
    Jan. 1, 2016. Revenues, expenditures and costs already assumed to
    begin Jan. 1, 2014, are netted against revenues, expenditures and
    costs generated from the initiative.</li> <li>Increased mandatory
    training, background checks and certification requirements vary by
    type of long-term care worker: <ul> <li>Beginning Jan. 7, 2012,
    workers who care for the elderly or persons with disabilities are
    required to complete 75 hours of mandatory training (up from 35
    hours), background checks and certification. The training includes
    five hours of basic safety information and orientation that must
    be completed before the worker begins employment. The remaining 70
    hours must be completed within 120 days of the worker being hired
    and can include 12 hours of structured peer mentoring.</li>
    <li>Beginning Jan. 7, 2012, workers hired as individual providers
    who care for their own elderly or disabled parent or child, or
    individual providers who work 20 hours or less per month are
    required to complete increased mandatory training (the amount
    varies), background checks and certification requirements.</li>
    <li>Beginning Jan. 1, 2016, workers who are community residential
    providers (supported living providers) are required to complete 75
    hours of mandatory training (up from 35 hours), and background
    checks, but do not require certification.</li> <li>All workers are
    required to complete 12 hours of continuing education courses each
    year to maintain certification. DSHS must offer, but not require,
    advanced training to long-term care workers.</li> </ul> <li>The
    number of workers who would receive training was developed using
    the June 2011 Caseload Forecast Council estimate of the number of
    long-term care clients.</li> <li>Current wage information was used
    as the basis for wage costs, with no inflationary increases
    included.</li> <li>The initiative does not trigger changes to the
    collective bargaining agreement reached between the state and the
    exclusive bargaining representative of long-term care
    workers. Therefore, no fiscal impact is assumed.</li> <li>No
    revenue, cost, expenditure or indebtedness impacts are assumed for
    local governments.</li> <li>There is no state debt associated with
    long-term care worker training and background check
    requirements. Therefore, state fiscal impacts are limited to
    revenues, costs and expenditures.</li> </ul> </p> <p> <b>State
    Revenue Impacts</b><br> The following table shows estimated
    revenues by fiscal year factoring in new revenue, revenues already
    assumed in the forecast, and reduced revenue from the delay of
    training and background checks for community residential
    providers. Estimates contained in parentheses ($XXX) represent a
    net revenue reduction.  <table > <tr > <td > <p ><b><span >Fiscal
    Year</span></b> </td> <td > <p ><b><span >2012</span></b> </td>
    <td > <p ><b><span >2013</span></b> </td> <td > <p ><b><span
    >2014</span></b> </td> <td > <p ><b><span >2015</span></b> </td>
    <td > <p ><b><span >2016</span></b> </td> <td > <p ><b><span
    >2017</span></b> </td> <td > <p ><b><span >REVENUE</span></b>
    </td> </tr> <tr > <td > <p ><span >Federal Funds</span> </td> <td
    ><span >$3,786,000</span> </td> <td ><span >$7,706,000</span>
    </td> <td > <p ><span >$2,745,000</span> </td> <td ><span
    >($3,385,000)</span> </td> <td > <p ><span >($1,583,000)</span>
    </td> <td > <p ><span >$218,000</span> </td> <td ><span
    >$9,487,000</span> </td> </tr> <tr > <td > <p ><span >Fees</span>
    </td> <td ><span >$717,000</span> </td> <td ><span
    >$2,027,000</span> </td> <td > <p ><span >$2,265,000</span> </td>
    <td ><span >$1,699,000</span> </td> <td > <p ><span
    >$1,274,000</span> </td> <td > <p ><span >$955,000</span> </td>
    <td ><span >$8,937,000</span> </td> </tr> <tr > <td > <p ><b><span
    >TOTAL</span></b> </td> <td ><b><span >$4,503,000</span></b> </td>
    <td ><b><span >$9,733,000</span></b> </td>
    <td><b>$5,010,000</span></b> </td> <td ><b><span
    >($1,686,000)</span></b> </td> <td > <p ><b><span
    >($309,000)</span></b> </td> <td > <p ><b><span
    >$1,173,000</span></b> </td> <td ><b><span >$18,424,000</span></b>
    </td> </tr> </table> </p> <p>Some training costs are eligible for
    50 percent matching funds from the federal government. The net
    increase in revenue from the federal government is estimated at
    $9.5 million over six fiscal years.</p> <p>Fees would be paid by
    long-term care workers applying for certification or renewing
    their certification.  Assuming a $60 certification fee, the net
    increase in revenue from fees is estimated at $8.9 million over
    six fiscal years.</p> <p>The initiative directs the state to
    develop a plan to cap administrative expenses of the long-term
    in-home care program to 10 percent of taxpayer spending by Jan. 1,
    2014. No fiscal impacts are assumed from this portion of the
    initiative. Based on FY 2011 expenditures, administrative expenses
    are currently estimated to be 9.9 percent of taxpayer spending
    using the following assumptions: <ul> <li>Administrative costs are
    assumed to mean overhead costs billed as administrative match to
    the federal Centers for Medicare &amp; Medicaid Services.</li>
    <li>Tax spending is assumed to mean expenditures funded from the
    State General Fund.</li> <li>The term &quot;direct care&quot; is
    assumed to mean any funds paid to qualified providers of long-term
    care services, including wages for hands-on workers and any of the
    provider&#39;s related overhead costs.</li> <li>The long-term
    in-home care program is assumed to mean providers of personal care
    as well as most forms of community-based care, including adult
    family homes and boarding homes. The definition does not include
    costs outside of DSHS&#39; in-home program, such as DOH&#39;s
    certification work.</li> </ul> </p> <p><b>State Expenditures and
    Costs</b><br> The following table shows estimated costs by fiscal
    year factoring in new costs, costs already assumed in the
    forecast, and reduced costs from the delay of training and
    background checks for community residential providers. Estimates
    contained in parentheses ($XXX) represent a net cost
    reduction.</p> <table > <tr > <td > <p ><b><span >Fiscal
    Year</span></b> </td> <td > <p ><b><span >2012</span></b> </td>
    <td > <p ><b><span >2013</span></b> </td> <td > <p ><b><span
    >2014</span></b> </td> <td > <p ><b><span >2015</span></b> </td>
    <td > <p ><b><span >2016</span></b> </td> <td > <p ><b><span
    >2017</span></b> </td> <td > <p ><b><span >COSTS</span></b> </td>
    </tr> <tr > <td width=98 > <p ><span >DSHS Costs</span> </td> <td
    ><span >$8,935,000</span> </td> <td ><span >$17,792,000</span>
    </td> <td ><span >$6,093,000</span> </td> <td ><span
    >($7,593,000)</span> </td> <td ><span >($3,571,000)</span> </td>
    <td ><span >$449,000</span> </td> <td ><span >$22,105,000</span>
    </td> </tr> <tr > <td width=98 > <p ><span >DOH Costs</span> </td>
    <td ><span >$1,841,000</span> </td> <td ><span >$2,588,000</span>
    </td> <td ><span >$1,654,000</span> </td> <td ><span
    >$355,000</span> </td> <td ><span >$357,000</span> </td> <td
    ><span >$294,000</span> </td> <td ><span >$7,089,000</span> </td>
    </tr> <tr > <td width=98 > <p ><span >State Auditor Costs</span>
    </td> <td ><span >$235,000</span> </td> <td ><span
    >$595,000</span> </td> <td ><span >$320,000</span> </td> <td
    ><span >$320,000</span> </td> <td ><span >$320,000</span> </td>
    <td ><span >$320,000</span> </td> <td ><span >$2,110,000</span>
    </td> </tr> <tr > <td width=98 > <p ><b><span
    >TOTAL&nbsp;</span></b> </td> <td ><b><span
    >$11,011,000</span></b> </td> <td ><b><span
    >$20,975,000</span></b> </td> <td ><b><span >$8,067,000</span></b>
    </td> <td ><b><span >($6,918,000)</span></b> </td> <td ><b><span
    >($2,894,000)</span></b> </td> <td ><b><span
    >$1,063,000</span></b> </td> <td ><b><span >$31,304,000</span></b>
    </td> </tr> </table> <p> <b>Department of Social and Health
    Services Expenditure and Cost Assumptions</b><br> DSHS would be
    required to approve the mandatory training curriculum, including
    continuing education and advanced training. DSHS would obtain
    background checks, including fingerprints, at no cost to the
    worker. Workers would be paid wages for the time they attend
    required training classes. Costs are also assumed for
    administrative staff, rule-making activities, information
    technology changes and contract administration. The combined net
    cost of these expenditures is estimated to be $19.6 million over
    six fiscal years.</p> <p> <b>Department of Health Expenditure and
    Cost Assumptions</b><br> DOH would certify workers who complete
    the required training and pass a background check within the first
    150 days of employment. Workers would not be paid for the time
    spent taking the certification exam. The combined net cost of
    these expenditures is estimated to be $7.1 million over six fiscal
    years.</p> <p><b>Performance Audit and Fraud Prevention
    Expenditure and Cost Assumptions</b><br> The initiative directs
    the Washington State Auditor&#39;s Office to conduct performance
    audits of the long-term in-home care program biannually, which is
    assumed to be twice per year. Assuming the term &quot;long-term
    in-home care program&quot; has the same meaning as used in State
    Revenue Impacts above, the Auditor&#39;s Office estimates it will
    need three full-time auditors and incur travel and other costs to
    conduct the audits. This cost is estimated to be $2.1 million over
    six fiscal years.</p> <p>The initiative directs the state to hire
    five additional fraud investigators as part of the performance
    auditing process. Assuming the investigators will be hired by
    DSHS, this cost is estimated to be $2.5 million over six fiscal
    years.</p>' )
...
o41 = Option.create!(
  ...
  :long_description => 'Seattle Proposition 1 approves a property tax
    ...
    the first year and the levy amount cannot grow by more than 1% per
    year.  The funding provided through Proposition 1 would be
    spent in seven major categories:<br> &nbsp;<br>
    1.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;">School readiness and early
    learning.</span> Major program elements include preschool for
    low-income three and four year olds; access for low-income
    families to high quality childcare; professional development for
    early education providers; school readiness support for children
    in home day-care situations, including home visits; health
    screenings; and preschool to kindergarten transition services.<br>
    &nbsp;<br>
    2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;">Academic achievement in
    elementary school.</span> Major program elements include extended
    learning time, out-of-school time activities, and summer learning
    programs; and school- and community-based family support
    services.<br> &nbsp;<br>
    3.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;">Academic achievement and
    college/career preparation in middle school.</span> Major program
    elements include extended learning time; out-of-school time
    activities; social, emotional, and behavioral supports; summer
    learning programs; and advising, guidance and related support for
    college readiness.<br> &nbsp;<br>
    4.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;">Academic achievement and
    college/career preparation in high school.</span> Major program
    elements include extended learning time; social, emotional, and
    behavioral supports; summer learning programs; and advising,
    guidance and related support for college readiness.<br> &nbsp;<br>
    5.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;">Student health.</span> Major
    program elements include school-based student health clinics and
    physical, mental and dental support services at clinic sites in
    middle and high schools; school-based health services at high-need
    elementary schools; and health services for high-risk middle and
    high school students in alternative school settings.<br>
    &nbsp;<br>
    6.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;">Community partnership
    fund.</span> Major program elements include funding for community
    and school-based partnerships to achieve Levy goals.<br>
    &nbsp;<br>
    7.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span style="font-weight: bold;">Research and Evaluation.</span>
    Major program elements include research and evaluation of the
    individual programs and services in the foregoing categories and
    of the overall outcomes of Education-Support Services funded by
    levy proceeds.<br> &nbsp;<br> Each year the City Council and Mayor
    will decide on the particular services to be funded within these
    categories, consistent with an Implementation and Evaluation Plan
    approved by ordinance.&nbsp; Funding for the Seattle School
    District would be controlled by a Partnership Agreement approved
    by ordinance.&nbsp; There will be an oversight committee composed
    of the Mayor, the Chair of the City Council&rsquo;s Public Safety
    and Education Committee, the Superintendent of the School
    District, a member of the School Board, and eight community
    members.&nbsp; This committee will make recommendations on the
    above-referenced plan and review programs and advise the City
    Council on proposed levy expenditures and reallocations to be
    adopted in the City&rsquo;s annual budget.<br> &nbsp;<br> In 1990,
    1997, and in 2004 Seattle voters approved &ldquo;Families and
    Education Levy&rdquo; property tax increases.&nbsp; Funds from the
    levies supported programs for children and their families both in
    and out of school.&nbsp; The 1990 and 1997 levies each totaled
    $69,000,000 over seven years.&nbsp; The 2004 levy totaled
    $116,788,000 over seven years.&nbsp; The 2004 levy will expire by
    the end of 2011.<br> &nbsp;<br> More information about this
    measure is available at:<br> <a
       href="http://www.seattle.gov/edlevy" 
       target="_blank">http://www.seattle.gov/edlevy</a>',
  :additional_details => ''
)
...
o42 = Option.create!(
  ...
  :long_description => 'If approved, this proposition imposes a $60
    ...
    Benefit District (STBD).&nbsp; The STBD and the City of Seattle
    have the same boundaries.<br> &nbsp;<br> The additional money
    would be used to contract with the City to provide for
    transportation improvements as follows:<br> <ol
    style="list-style-type: upper-alpha;"> <li>Approximately 29% will
    be allocated for transportation system repair, maintenance and
    safety.</li> <li>Approximately 49% will be allocated for
    implementing transit speed, reliability and access improvement
    projects and programs.</li> <li>Approximately 22% will be
    allocated for implementing pedestrian, bicycle and freight
    mobility projects and programs.</li> </ol> <br> The STBD
    anticipates that City&rsquo;s Department of Transportation will
    submit a spending plan each year for STBD&rsquo;s review and
    approval in adopting an annual budget.&nbsp; The revenues from the
    additional $60 VLF fee will be spent consistent with planned
    spending priorities, included in Attachment A to STBD Resolution
    No. 5 (available online at <a
    href="http://www.kingcounty.gov/elections" 
      target="_blank">www.kingcounty.gov/elections</a>).<br>
    &nbsp;<br> The STBD may change the planned spending priorities or
    the Percentage Allocations through a majority vote held during a
    public meeting of the STBD Board.<br> &nbsp;<br> The STBD may
    impose a vehicle license fee (VLF) of up to $100.&nbsp; The STBD
    previously imposed a $20 VLF, with collection beginning on May 1,
    2011.&nbsp; The additional $60 VLF proposed by this measure would
    expire after ten years.&nbsp; These amounts are exclusive of any
    VLF imposed by the state or county.<br> &nbsp;<br> For more
    information about the STBD or this measure please visit the STBD
    website:<br> &nbsp;<br> <a
    href="http://www.seattle.gov/stbd/" 
      target="_blank">http://www.seattle.gov/stbd/</a>. ',
  :additional_details => ''
)
...
o47 = Option.create!(
  ...
  :description => 'The Board of Directors of the Si View Metropolitan
    Park District adopted Resolution No. 2011-02 concerning protecting
    a portion of the existing property tax levy from being reallocated
    to other taxing districts, a process known as prorationing.  To
    maintain current operations, park district facilities and
    programs, including the Si View Community Center and Pool, parks,
    playfields, playgrounds, trails, adult programming, fitness and
    youth sports programs, summer camps, and after-school recreation
    programs for youth and teens, shall $0.25/$1,000 of assessed
    valuation of the District&rsquo;s current regular property tax
    levy be protected from prorationing under RCW 84.52.010(3)(b) for
    the tax years 2012 through 2017?',
