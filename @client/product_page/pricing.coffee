...
tech_qs = [
  ...
  }
  {
    ...
    a: """Yes, Consider.it is <a href='https://www.w3.org/WAI/intro/wcag.php'>WCAG</a> Level A compliant. <a href='/tour#accessibility'>Learn more</a>."""
  }
  {
    l: 'vanity_url'    
