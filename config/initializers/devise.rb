...
Devise.setup do |config|
  ...
  config.omniauth :google_oauth2, conf['google']['consumer_id'], conf['google']['consumer_secret'], { :access_type => "offline", :approval_prompt => "", :scope => 'userinfo.email,userinfo.profile' }
