ConsiderIt::Application.configure do
  ...
  config.assets.precompile += %w( browser/ie.css browser/ie9.css mailer/email.css javascripts/load_everything.js dash.js admin/admin.css *.svg *.eot *.woff *.ttf *.jpg *.png *.jpeg *.gif)
