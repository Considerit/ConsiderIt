...
module Reflect
  module Reflectable
    def is_reflectable
      ...
      has_many :reflect_bullets, :as=>:comment, :class_name => 'Reflect::ReflectBullet', :dependent => :destroy
      has_many :reflect_bullet_revisions, :as=>:comment, :class_name => 'Reflect::ReflectBulletRevision', :dependent => :destroy
