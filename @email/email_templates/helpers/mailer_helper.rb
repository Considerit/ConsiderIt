module MailerHelper
  ...
  def section(name)
    section_name = Translations::Translation.get({
  ...
  def relationship(rel)
    rel_text = Translations::Translation.get("email.digest.relationship.#{rel}", rel)
    if @part == 'text'
      "*#{rel_text}*"
    else 
  ...
  def proposal_header(proposal_info, with_events)
    ...
    if @part == 'text'
      ...
      view_text = Translations::Translation.get(
  ...
  def proposal_events(events)
    ...
    if @part == 'text'
      text = Translations::Translation.get("email.digest.proposal_activity.text", "New activity") + ":\r\n"
    else 
    ...
    events.each do |ev|
      ...
      event_heading = Translations::Translation.get({
  ...
  def point_link(point, relationship=false)
    ...
    if @part == 'text'
      ...
      translated_link = Translations::Translation.get(
