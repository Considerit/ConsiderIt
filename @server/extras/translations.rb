...
module Translations
  def Translations.SetTranslationContext(user, subdomain)
  ...
  def Translations.ClearTranslationContext
    @translator_user = nil 
    @translator_subdomain = nil
  end    


  def Translations.GetTranslations(k)
  ...
  def Translations.translate(args, native_text = nil)
    ...
    translations_native = Translations.GetTranslations(native_key)
    ...
    if !translations_native[id] || translations_native[id]["txt"] != native_text
      ...
      Translations.UpdateTranslations(native_key, translations_native)
      Translations::PSEUDOLOCALIZATION::synchronize(native_key)
    end 
    ...
    langs.each do |lang| 
      ...
      lang_trans = Translations.GetTranslations(lang_key)
  ...
  def Translations.TranslatorHTML(args, native_text)
    if args.is_a? String
      native_text = args
      args = {}
    end 

    message = Translations.translate args, native_text
  ...
  module PSEUDOLOCALIZATION
    ...
    def self.synchronize(key)
      ...
      en = Translations.GetTranslations("#{prefix}/en")
      ps = Translations.GetTranslations(ps_key)
      ...
      if dirty 
        Translations.UpdateTranslations(ps_key, ps)
      end
