...
$j.fn.infiniteCarousel = function(o) {
    ...
    return this.each(function () {
        ...
        function updatePagination(page){
          ...
          if ( data.last >= data.$items.length - data.items_per_page && data.last < totalItems() ) {
        ...
        function gotoPage(page) {
          ...
          if ( page > data.currentPage ) {
            ...
            data.last = data.last == 0 ? Math.min(totalItems(), data.items_per_page) : Math.min(data.last, totalItems());   
          }
