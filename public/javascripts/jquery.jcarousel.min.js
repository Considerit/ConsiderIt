    ...
    return this.each(function () {
        ...
        function updatePagination(page){
          ...
          if ( last == $items.length && last < totalItems() ) {
            ...
            var str = $carousel.find('.forward.ajax').show().attr('href'),
                next = page + 1;
            $carousel.find('.forward.ajax').attr('href', str.replace(/\b(page\=)[0-9]+\b/g, 'page=' + next));
        ...
        $(this).delegate('a.back', 'click', function () {
          return gotoPage(currentPage - 1);                
        });

        $(this).delegate('a.forward.not_ajax', 'click', function () {
          return gotoPage(currentPage + 1);
        });

        $(this).delegate('a.forward.ajax', 'ajax:success', function (data, response, xhr) {
